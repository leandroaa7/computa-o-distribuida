...
class UDPServer {
   ...
   private static String converterMensagem(DatagramSocket serverSocket, DatagramPacket receivePacket) throws Exception {
   ...
   public static void main(String args[]) throws Exception {
      ...
      while (true) {
         ...
         mensagemRecebida = converterMensagem(serverSocket, receivePacket);//converter mensagem
